...
namespace Zeng.GameFrame.UIS
{
    ...
    public class UIBlockLayer
    {
        ...
        {
            CountDownMgr.I.Remove(ref m_LastCountDownGuid);
        }

        //初始化添加屏蔽模块
        public void Init(RectTransform UILayerRoot)
        {
        ...
        private void BanLayerOptionCountDown(float time)
        {
            ...
            if (currentRecoverOptionTime > m_LastRecoverOptionTime)
            {
                ...
                RemoveLastCountDown();
                CountDownMgr.I.Add(ref m_LastCountDownGuid, time, OnCountDownLayerOption);
            }
        }
