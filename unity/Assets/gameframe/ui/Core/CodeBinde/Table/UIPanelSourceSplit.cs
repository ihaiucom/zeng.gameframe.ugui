...
namespace Zeng.GameFrame.UIS
{
    ...
    public static class UIPanelSourceSplit
    {
        ...
        {
            //View 查找
            var view = viewParent.FindChildByName(viewParent.name.Replace(UISetting.UIParentName, ""));
            if (view == null)
            {
            ...
            var oldView = oldViewParent.FindChildByName(oldViewParent.name.Replace(UISetting.UIParentName, ""));
            if (oldView == null)
            {
