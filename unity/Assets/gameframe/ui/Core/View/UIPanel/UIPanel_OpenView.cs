...
namespace Zeng.GameFrame.UIS
{
    ...
    public abstract partial class UIPanel
    {
        ...
        private Dictionary<string, UIView> m_ExistView = new ();
        ...
        private void AddViewParent(List<RectTransform> listParent)
        {
            ...
            {
                var viewName = parent.name.Replace(UISetting.UIParentName, "");
        ...
        private void CreateCommonView()
        {
            ...
            {
                var viewName = commonParentView.name.Replace(UISetting.UIParentName, "");
                ...
                var viewBase = UIFactory.CreateCommon(UIPkgName, viewName, viewTsf.gameObject);
                ...
                {
                    case UIView UIView:
                        m_ExistView.Add(viewName, UIView);
                        break;
                    default:
        ...
        private async UniTask<T> GetView<T>() where T : UIView
        {
        ...
        public (bool, UIView) ExistView<T>() where T : UIView
        {
            ...
            if (m_ExistView.TryGetValue(viewName, out var UIView))
            {
                return (true, UIView);
            }
        ...
        /// 打开之前
        /// </summary>
        private async UniTask OpenViewBefore(UIView view)
        {
        ...
        /// 打开之后
        /// </summary>
        private async UniTask OpenViewAfter(UIView view, bool success)
        {
            if (success)
            {
                if (view.WindowFirstOpen)
        ...
        private async UniTask CloseLastView(UIView view)
        {
            //其他需要被忽略
