...
namespace Zeng.GameFrame.UIS
{
    ...
    /// 可嵌套使用 达到无限穿透效果
    /// </summary>
    [AddComponentMenu("UIFramework/Widget/点击穿透 【UIClickEventPenetration】")]
    public class UIClickEventPenetration: MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IPointerClickHandler
    {
        [LabelText("穿透 按下")]
