...
namespace Zeng.GameFrame.UIS
{
        ...
        IDragHandler, IPointerDownHandler, IPointerUpHandler
    {
        ...
        private const string UI3DLayer = "UI3DLayer";

        [ShowInInspector]
        [LabelText("当前显示层级")]
        [ReadOnly]
        private string m_ShowLayerName = UI3DLayer;
        ...
        private Camera UICamera
        {
            get
            {
                ...
                m_UICamera = UIManager.I.uiRoot.UICamera;
                return m_UICamera;
            }
        }
        ...
        private void ChangeLayerName(string layerName)
        {
            ...
            if (layerName == UI3DLayer)
            {
                Debug.LogError($"第一次使用请手动创建 UI3DLayer 层级");
                return;
            }

            Debug.LogError($"当前设定的UI层级不存在请检查 {layerName} 强制修改层级为 {UI3DLayer}");
            m_ShowLayerName = UI3DLayer;
            m_ShowLayer     = LayerMask.NameToLayer(UI3DLayer);
        }
