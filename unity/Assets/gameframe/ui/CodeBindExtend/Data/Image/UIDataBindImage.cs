...
namespace Zeng.GameFrame.UIS
{
    ...
    [LabelText("Image 图片")]
    [AddComponentMenu("UIBind/Data/图片 【Image】 UIDataBindImage")]
    public sealed class UIDataBindImage : UIDataBindSelectBase
    {
        ...
        {
            using var asyncLock = await AsyncLockMgr.I.Wait(GetHashCode());
...
#if UNITY_EDITOR
            if (!UILoad.VerifyAssetValidity(resName))
            {
            ...
            var sprite = await UILoad.LoadAssetAsync<Sprite>(resName);
