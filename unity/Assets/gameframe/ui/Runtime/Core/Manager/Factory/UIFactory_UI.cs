...
namespace Zeng.GameFrame.UIS
{
    public static partial class UIFactory
    {
        ...
        internal static UIBase CreatePanel(UIWindowInfo uiWindowInfo)
        {
            return Create(uiWindowInfo.PkgName, uiWindowInfo.ResName);
        }
        ...
        {
            var obj = UILoad.LoadAssetInstantiate(vo.PkgName, vo.ResName);
            if (obj == null)
            {
