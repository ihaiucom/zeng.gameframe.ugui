...
namespace Zeng.GameFrame.UIs
{
    ...
    public static class UIStaticHelper
    {
        ...
        public const string UITemplatePath = UIFrameworkPath + "/Editor/Template";

        public const string UIRootPrefabPath =
            UIFrameworkPath + "/Editor/Prefab/UIRoot.prefab";

        public const string UIBaseName               = nameof(BaseUI);
        public const string UIBasePanelName          = nameof(BaseWindow);
